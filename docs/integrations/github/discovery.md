...
When creating the webhook in GitHub the "Payload URL" will look like something along these lines: `https://<your-intance-name>/api/events/http/github` and the "Content Type" should be `application/json`.
